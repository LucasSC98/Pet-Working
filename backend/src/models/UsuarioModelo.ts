...
import { validarCPF, validarEmail, validarSenha, validarDataNascimento } from "../validadores/ValidacaoUsuario";
        ...
        validate: {
            validarSenha: async (value: string) => {
                if (!validarSenha(value)) {
                    throw new Error('Senha inválida, deve conter pelo menos uma letra maiúscula e um número')
                }
            }
        }
    },
