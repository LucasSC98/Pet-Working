...
import { buscarTodosPets, buscarPetPorId, criarNovoPet, atualizarDadosPet, deletarPet, buscarPetsPorUsuario, deletarPetPorUsuario } from '../controllers/PetsController';
...
router.delete('/pets/:id/usuario/:userId', deletarPetPorUsuario);
