...
import { buscarTodosAgendamentos, buscarAgendamentoPorId, criarNovoAgendamento, atualizarDadosAgendamento, deletarAgendamento, buscarAgendamentosPorUsuario, cancelarAgendamento } from "../controllers/AgendamentosController";
