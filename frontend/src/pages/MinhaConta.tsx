  ...
  const handleImageChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      try {
        ...
        setDadosUsuario((prev) => ({ ...prev, fotoDePerfil: imageUrl }));
        atualizarDadosDoUsuario({ fotoDePerfil: imageUrl });
        ...
        setMensagem({
          tipo: "erro",
          texto: "Erro ao enviar imagem. Tente novamente.",
        });
      } finally {
        setCarregando(false);
      }
    ...
    try {
      ...
      setMensagem({
        ...
        texto:
          ...
          "Erro ao atualizar seus dados. Tente novamente.",
      });
    } finally {
      setCarregando(false);
    }
                  ...
                  {alterandoSenha && (
                    <div className="form-row">
                      <div className="form-group">
                        ...
                        <p>
                          {" "}
                          A senha deve conter 6 caracteres, pelo menos uma letra
